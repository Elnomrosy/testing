...
public class test_advancedsearchinvalidauthor {
	public static void main(String args[]) {
		...
		driver.findElement(By.name("title")).sendKeys("Integrated Science Textbook");
		
		driver.findElement(By.name("author")).sendKeys("abdo");
